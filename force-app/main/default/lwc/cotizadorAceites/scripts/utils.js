...
export function getPriceLabel(sellingPrice, unitMeasure, currency = "usd") {
	const catalog = { mt: "Mton", kg: "Kg", litro: "Litro", pza: "Pza" };
	return currency.toUpperCase() + "/" + catalog[unitMeasure];
}

export function getVolume(unitMeasure) {
	return unitMeasure === "mt" ? "M Tons" : "Kilograms";
}
